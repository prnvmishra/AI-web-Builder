        ...
        <Link to='/'>
          ...
          {!session?.user ? (
            ...
            <button onClick={() => {
              signOut(auth);
              navigate('/');
            }} className='bg-red-500/10 px-5 py-1.5 text-xs sm:text-sm border border-red-500/30 text-red-400 hover:bg-red-500/20 rounded-full transition'>
              Logout
            </button>
            <Link to="/settings" className="w-8 h-8 flex items-center justify-center bg-indigo-600 text-white rounded-full">
