                             ...
                             <div className='p-4 text-white bg-linear-180 from-transparent group-hover:from-indigo-950 to-transparent transition-colors'>
                                <div className='flex items-start justify-between'>
                                    ...
                                    <div className='flex gap-2 items-center'>
                                        {project.status === 'pending' && <span className='px-2 py-0.5 text-[10px] bg-yellow-500/20 text-yellow-500 border border-yellow-500/50 rounded-full animate-pulse'>Pending</span>}
                                        {project.status === 'revising' && <span className='px-2 py-0.5 text-[10px] bg-blue-500/20 text-blue-500 border border-blue-500/50 rounded-full animate-pulse'>Revising</span>}
                                        {project.status === 'error' && <span className='px-2 py-0.5 text-[10px] bg-red-500/20 text-red-500 border border-red-500/50 rounded-full'>Failed</span>}
                                        <button className='px-2.5 py-0.5 text-xs bg-gray-800 border border-gray-700 rounded-full'>Website</button>
                                    </div>
                                </div>
